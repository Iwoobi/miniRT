...
/*   Updated: 2022/10/25 22:20:19 by chanhyle         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// int	xpm_color_select(t_mlx *mlx, unsigned int *rgb)
int	xpm_color_select(t_mlx *mlx)
{
	double	i;
	double	j;
	...
	return (mlx->xpm.data[(int)(i * mlx->xpm.w / 2) + (int)(mlx->xpm.w * j * mlx->xpm.h / 2)]);
}
